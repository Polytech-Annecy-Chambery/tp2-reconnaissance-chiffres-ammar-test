...
class Image:
    ...
    def localisation(self):
        # recherche des limites de la forme
        l_min = self.H - 1
        l_max = 0
        c_min = self.W - 1
        c_max = 0
    ...
    def resize(self, new_H, new_W):
        ...
        # construction de l'image redimensionnee
        image_resized = Image()
        image_resized.set_pixels(pixels_resized)   
